            ...
            <div className="containter" style={{border:"2px solid black",borderRadius:"10px"}}>
                ...
                <div className="row justify-content-center">
                    ...
                    <div className='col-lg-8'>
                        ...
                        <div className="row">
                            <div className='col-lg-6'>
                                <h4 style={{marginTop:"20px"}}>Tipo</h4>
                            </div>
                            <div className="col-lg-6">
                                <div className="form-group">
                                    <br />
                                    <select className='form-control' style={{textAlign:"center",background:"rgba(217, 217, 217, 0.45)"}}>
                                        ...
                                        <option value="">pqr 1</option>
                                        <option value="">pqr 2</option>
                                        <option value="">pqr 3</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        <div className="row">
                            <div className='col-lg-6'>
                                <h4 style={{marginTop:"20px"}}>Descripcion PQR</h4>
                            </div>
                            <div className="col-lg-6">
                                <div className="form-group">
                                    <input type="text" className='form-control' placeholder='Descripcion' style={{textAlign:"center",background:"rgba(217, 217, 217, 0.45)"}} />
                                </div>
                            </div>
                        </div>
                            <br />
